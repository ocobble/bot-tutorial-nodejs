...
"Oh, yo! What do we have here? University of Texas Austin drum corps! Going up to the Ram Ranch spaceship! Gonna become boys to save the boys up in the Ram Ranch spacecraft! Being buttf*cked by the black c*ck gang, black c*ck gang f*ckin and f*ckin and f*ckin and f*ckin!",

"Yo! Allicat, Clay, Tyler, and Andrew! Sydney and Scott Rich! Jason and Micah! Yo, super cool jock boys from Texas! Gonna f*ckin f*ckin f*ck black c*ck gang! Yo! Huge hard Texas cowboy c*cks hard as rocks, gonna f*ckin f*ckin f*ck black c*ck gang"

];

setInterval(function() {
    // Only wake up if not between 2 and 8
    var currHour = Math.floor(Date.now() / 3600000) % 24 - 6;
    console.log("The time is " + currHour);
    if (currHour < 2 || currHour > 9)
    {
